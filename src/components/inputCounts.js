...
export default class InputCounts extends Component {
    ...
    render() {
        ...
        return (
            <Container>
                <InputGroup>
                    <InputArea size='60' placeholder='Enter title here...' required={true} maxLength={parseFloat(this.props.max_char)} value={this.state.value} onChange={this.handleChange}/>
                    <ProgressBarStyled >
                        <CircularProgressbar
...
InputCounts.defaultProps = {max_char: 51};
